...
var index$2 = require('./auth/index.js');
var index$3 = require('./session/index.js');
var index$4 = require('./utils/index.js');
var index$5 = require('./webhooks/index.js');
var index$6 = require('./billing/index.js');
var index$9 = require('./logger/index.js');
var version = require('./version.js');
var client$1 = require('./clients/admin/rest/client.js');
var index$7 = require('./flow/index.js');
var index$8 = require('./fulfillment-service/index.js');
...
function shopifyApi({ future, restResources, ...config$1 }) {
    ...
    const shopify = {
        ...
        auth: index$2.shopifyAuth(validatedConfig),
        session: index$3.shopifySession(validatedConfig),
        utils: index$4.shopifyUtils(validatedConfig),
        webhooks: index$5.shopifyWebhooks(validatedConfig),
        billing: index$6.shopifyBilling(validatedConfig),
        flow: index$7.shopifyFlow(validatedConfig),
        fulfillmentService: index$8.fulfillmentService(validatedConfig),
        logger: index$9.logger(validatedConfig),
        rest: {},
    };
    if (restResources) {
